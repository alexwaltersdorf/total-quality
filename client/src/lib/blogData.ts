...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "A Total Quality Medicina Diagnóstica é o laboratório de análises clínicas mais completo de Caraguatatuba - SP, realizando mais de 3.000 tipos de exames laboratoriais. Localizada no centro da cidade, na R. Padre Anchieta, 1010, a clínica oferece coleta de sangue de segunda a sexta-feira, das 06h30 às 16h, e aos sábados das 06h30 às 11h. Os resultados ficam disponíveis online em até 24 horas para a maioria dos exames.",
