...
export const examesData: ExamData[] = [
  {
    ...
    metaDescription: "Exames de sangue em Caraguatatuba na Total Quality. Coleta por ordem de chegada, sem agendamento. Consulte preparo, prazos, convênios e orçamento pelo WhatsApp.",
    ...
    whatsappMessage: "Olá! Gostaria de consultar preparo e orçamento de exames de sangue.",
  ...
  },
  {
    ...
    metaTitle: "Ultrassonografia em Caraguatatuba | Total Quality",
    ...
    indications: [
      ...
      "Ultrassom transvaginal (avaliação ginecológica)",
      "Avaliação de mama",
    ...
    preparations: [
      ...
      { icon: CheckCircle, text: "Ultrassom de tireoide, mama e musculoesquelético: sem preparo especial" },
      { icon: FileText, text: "Traga exames anteriores para comparação" },
    ],
    faqs: [
      ...
      { q: "Preciso de preparo?", a: "Depende do tipo de ultrassom. Abdominal requer jejum de 6-8h. Pélvico requer bexiga cheia. Tireoide, mama e musculoesquelético não necessitam preparo." },
  ...
  },
  {
    ...
    metaTitle: "MAPA 24h em Caraguatatuba | Total Quality",
  ...
  },
  {
    ...
    metaTitle: "Holter 24h em Caraguatatuba | Total Quality",
  ...
  },
{
    ...
    metaTitle: "Hemograma Completo em Caraguatatuba | Total Quality",
  ...
  },
  {
    ...
    metaTitle: "Exame Admissional em Caraguatatuba | Total Quality",
