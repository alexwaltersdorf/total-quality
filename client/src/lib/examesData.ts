...
export const examesData: ExamData[] = [
  {
    ...
    metaDescription: "Laboratório de análises clínicas em Caraguatatuba - SP há 21 anos. Mais de 3.000 exames de sangue: hemograma, glicemia, colesterol, hormônios, vitamina D, PSA, TSH. Resultados rápidos.",
  ...
  },
  {
    ...
    metaDescription: "Tomografia computadorizada em Caraguatatuba - SP na Total Quality. Tomógrafo multislice de última geração para crânio, tórax, abdômen, coluna e articulações. Laudo rápido. Agende.",
  ...
  },
  {
    ...
    metaDescription: "Raio-X digital em Caraguatatuba - SP na Total Quality. Imagens em alta resolução de tórax, coluna, membros, seios da face e articulações. Laudo no mesmo dia. Agende já.",
