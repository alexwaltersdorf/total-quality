...
export const examesData: ExamData[] = [
  {
    ...
    faqs: [
      ...
      { q: "Como agendar um exame de sangue em Caraguatatuba?", a: "O agendamento é rápido: chame no WhatsApp (12) 3887-3535 ou ligue no mesmo número informando os exames do seu pedido médico. Você já recebe as orientações de preparo e escolhe o melhor horário, de segunda a sexta, das 7h30 às 18h." },
