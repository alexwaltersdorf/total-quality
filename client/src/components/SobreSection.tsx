 ...
 * Sobre: Company history, values, and timeline
 */
      ...
      <div className="container">
        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-start mb-24">
          ...
          <div className="lg:col-span-6 reveal-right pt-4 lg:pt-12">
            ...
            <h2 className="heading-display text-5xl sm:text-6xl text-foreground mb-8">
              SOBRE A
              <br />
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              <div className="border border-black/10 p-5">
                ...
                <p className="text-sm font-semibold text-foreground mb-1">Sustentabilidade</p>
                <p className="text-xs text-muted-foreground">85% da energia proveniente de painéis solares</p>
              </div>
              <div className="border border-black/10 p-5">
                <GraduationCap className="w-5 h-5 text-brand mb-3" />
                <p className="text-sm font-semibold text-foreground mb-1">Parceria Acadêmica</p>
                <p className="text-xs text-muted-foreground">Convênio com UNITAU para ensino e pesquisa</p>
              </div>
            </div>
        ...
        <div className="mb-24">
          <div className="flex items-center gap-4 mb-12">
            ...
            <h3 className="heading-display text-3xl text-foreground">NOSSOS VALORES</h3>
          </div>
          <div className="grid sm:grid-cols-3 gap-0">
            {values.map((item, i) => (
              ...
              >
                ...
                <h4 className="heading-display text-2xl text-foreground mb-3">{item.title.toUpperCase()}</h4>
        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          <div className="lg:col-span-5">
            <div className="flex items-center gap-4 mb-10">
              <div className="w-12 h-[1px] bg-brand" />
              <h3 className="heading-display text-3xl text-foreground">NOSSA TRAJETÓRIA</h3>
            </div>
