 ...
 * Layout: Video on the left, text content on the right (sticky alongside).
...
export default function ScrollVideo({ src, alt = "Vídeo", children }: ScrollVideoProps) {
    ...
    >
      ...
      <div className="sticky top-0 h-screen overflow-hidden bg-white">
        ...
        <div className="h-full flex flex-col lg:flex-row items-center">
          ...
          {/* Left: Video */}
          <div className="relative flex-1 h-full flex items-center justify-center lg:w-1/2">
          ...
          {/* Right: Text content (only on desktop) */}
          {children && (
            <div className="hidden lg:flex lg:w-5/12 h-full items-center px-8 xl:px-12">
