 ...
 * Page: Bioimpedância — Detailed service page with benefits, metrics, and scheduling
 */
...
const metrics = [
  {
    ...
    desc: "Quantidade total de músculo esquelético no corpo, essencial para metabolismo e mobilidade.",
    color: "text-brand",
  },
  {
    icon: Droplets,
    title: "Gordura Corporal",
    desc: "Percentual de tecido adiposo em relação ao peso total, indicador-chave de saúde metabólica.",
    color: "text-brand",
  },
  {
    icon: Zap,
    title: "Água Corporal",
    desc: "Nível de hidratação intra e extracelular, fundamental para o funcionamento dos órgãos.",
    color: "text-brand",
  },
  {
    icon: Bone,
    title: "Massa Óssea",
    desc: "Densidade mineral dos ossos, importante para prevenir osteoporose e fraturas.",
    color: "text-brand",
  },
  {
    icon: Flame,
    title: "Taxa Metabólica Basal",
    desc: "Calorias que seu corpo queima em repouso, base para planejamento nutricional.",
    color: "text-brand",
  },
  {
    icon: BarChart3,
    title: "Gordura Visceral",
    desc: "Gordura ao redor dos órgãos internos, fator de risco para doenças cardiovasculares.",
    color: "text-brand",
  },
];
...
const whoNeeds = [
  {
    ...
    desc: "Otimize sua composição corporal para melhor desempenho e recuperação.",
  },
  {
    icon: Target,
    title: "Emagrecimento",
    desc: "Monitore se está perdendo gordura ou massa muscular durante a dieta.",
  },
  {
    icon: Users,
    title: "Acompanhamento Nutricional",
    desc: "Dados precisos para nutricionistas ajustarem planos alimentares.",
  },
  {
    icon: Flame,
    title: "Saúde Metabólica",
    desc: "Avalie riscos metabólicos como resistência à insulina e síndrome metabólica.",
  },
];

const faqs = [
  {
    q: "O exame de bioimpedância dói?",
    a: "Não. O exame é completamente indolor e não invasivo. Uma corrente elétrica de baixíssima intensidade percorre o corpo, imperceptível ao paciente.",
  },
  {
    q: "Quanto tempo dura o exame?",
    a: "O exame leva aproximadamente 5 a 10 minutos. Os resultados são gerados instantaneamente após a medição.",
  },
  {
    q: "Preciso de algum preparo?",
    a: "Sim. Recomendamos jejum de 4 horas, não praticar exercícios 12 horas antes, não consumir álcool 24 horas antes e estar bem hidratado.",
  },
  {
    q: "Com que frequência devo repetir?",
    a: "Para acompanhamento, recomendamos a cada 3 meses. Para atletas ou programas de emagrecimento, pode ser mensal.",
  },
  {
    q: "Gestantes podem fazer?",
    a: "Não é recomendado para gestantes e portadores de marcapasso cardíaco. Consulte seu médico antes de realizar o exame.",
  },
];
...
export default function Bioimpedancia() {
  ...
  return (
    <div ref={wrapperRef} className="min-h-screen bg-white">
        ...
        <div className="container">
          <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-start">
            ...
            <div className="lg:col-span-5 pt-8 lg:pt-16">
              ...
              <h1 className="reveal heading-display text-[clamp(3rem,8vw,6.5rem)] text-foreground leading-[0.85] mb-6" style={{ transitionDelay: "100ms" }}>
                BIO
                <br />
            ...
            <div className="lg:col-span-7 reveal-right">
              <div className="relative">
                <img
                  src={HERO_IMG}
                  alt="Exame de Bioimpedância - Análise de composição corporal"
                ...
                <div className="absolute bottom-6 left-6 bg-white/95 backdrop-blur-sm p-5 max-w-xs">
                  ...
                  <p className="text-sm text-muted-foreground">Exame rápido, indolor e com resultados imediatos</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 lg:py-32 border-t border-black/5">
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="reveal">
              <span className="section-label mb-6 block">O Exame</span>
              <h2 className="heading-display text-[clamp(2.5rem,5vw,4.5rem)] text-foreground leading-[0.9] mb-6">
                O QUE É A
                <br />
                <span className="text-brand">BIOIMPEDÂNCIA?</span>
              </h2>
            ...
            <div className="reveal-right">
              <img
                src={DETAIL_IMG}
                alt="Relatório de composição corporal por bioimpedância"
      ...
      {/* Metrics Section */}
      <section id="metricas" className="py-24 lg:py-32 bg-[#fafaf8]">
        <div className="container">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {metrics.map((m, i) => (
              <div
                key={m.title}
                className="reveal bg-white p-8 border border-black/5 hover:border-brand/20 transition-all duration-300 group"
                style={{ transitionDelay: `${i * 80}ms` }}
              >
                <div className="flex items-start gap-4 mb-4">
                  <div className="w-12 h-12 flex items-center justify-center bg-brand-50 text-brand flex-shrink-0 group-hover:bg-brand group-hover:text-white transition-all duration-300">
                    <m.icon className="w-5 h-5" />
                  </div>
                  <h3 className="heading-display text-xl text-foreground pt-2">{m.title}</h3>
                </div>
            ...
            <div className="lg:col-span-5">
              <div className="reveal lg:sticky lg:top-28">
                ...
                <h2 className="heading-display text-[clamp(2.5rem,5vw,4.5rem)] text-foreground leading-[0.9] mb-6">
                  PARA QUEM É
                  <br />
                  <span className="text-brand">INDICADO?</span>
                </h2>
            ...
            <div className="lg:col-span-7">
              <div className="space-y-0">
                {whoNeeds.map((item, i) => (
                  ...
                  >
                    <div className="w-14 h-14 flex items-center justify-center bg-brand-50 text-brand flex-shrink-0">
                      <item.icon className="w-6 h-6" />
                    </div>
                    <div>
                      <h3 className="heading-display text-2xl text-foreground mb-2">{item.title}</h3>
          ...
          <div className="grid lg:grid-cols-12 gap-16">
            <div className="lg:col-span-4">
              <div className="reveal lg:sticky lg:top-28">
                ...
                <h2 className="heading-display text-[clamp(2.5rem,5vw,4rem)] text-foreground leading-[0.9] mb-6">
                  PERGUNTAS
                  <br />
            ...
            <div className="lg:col-span-8">
              <div className="space-y-0">
                {faqs.map((faq, i) => (
                  <details
                    key={i}
                    className="reveal group border-b border-black/5"
                    style={{ transitionDelay: `${i * 80}ms` }}
                  >
                    <summary className="flex items-center justify-between py-6 cursor-pointer list-none">
                      <h3 className="heading-display text-xl text-foreground group-hover:text-brand transition-colors pr-4">
                        {faq.q}
                      </h3>
                      <span className="heading-display text-2xl text-brand flex-shrink-0 transition-transform group-open:rotate-45">
                        +
                      </span>
                    </summary>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="reveal">
              <h2 className="heading-display text-[clamp(2.5rem,5vw,5rem)] leading-[0.85] mb-6">
                CONHEÇA SEU
                <br />
                <span className="text-brand-light">CORPO POR DENTRO</span>
              </h2>
      ...
      <section className="py-12 border-t border-black/5">
        <div className="container flex items-center justify-between">
          ...
          <Link href="/checkup" className="flex items-center gap-2 text-sm text-muted-foreground hover:text-brand transition-colors">
            Check-Up Preventivo
