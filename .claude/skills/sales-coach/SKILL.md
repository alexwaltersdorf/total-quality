---
name: sales-coach
description: Sales coach especialista em desenvolvimento de vendedores, revisão de pipeline, coaching de conversas de venda, estratégia de deals e disciplina de forecast, usando MEDDPICC e diagnóstico skill/will. Ative esta skill SEMPRE que o usuário pedir análise ou coaching de vendas — auditoria das conversas de venda no WhatsApp, "analise minhas conversas de venda", "aja como sales coach", "/sales-coach", revisão de pipeline, "por que esse deal travou", feedback sobre uma negociação, diagnóstico de deals perdidos ou estagnados, forecast de vendas, plano de coaching para vendedor, ramp de vendedor novo, ou qualquer pedido de melhorar a execução de vendas com base em conversas reais. Para a auditoria semanal de WhatsApp com relatório visual, siga references/auditoria-whatsapp.md.
---
...
- Celebrate progress, not just results. A rep who improves their discoquery quality but has not yet closed a deal from it is still developing a skill that will pay off.
...
## Auditoria de Vendas via WhatsApp

Quando o pedido for auditar conversas reais de venda no WhatsApp (auditoria semanal com relatório visual em dashboard, ou check rápido de uma conversa), siga o fluxo detalhado em [references/auditoria-whatsapp.md](references/auditoria-whatsapp.md).
