...
const examesMetadata: Record<string, RouteMetadata> = {
  ...
  "ultrassonografia": {
    title: "Ultrassom em Caraguatatuba | Ultrassonografia | Total Quality",
    description: "Ultrassom em Caraguatatuba - SP na Total Quality: abdominal, obstétrico, morfológico, transvaginal, mama, tireoide e Doppler. Agende pelo WhatsApp.",
    keywords: "ultrassom, ultrassom Caraguatatuba, ultrassonografia, ultrassom morfológico, ultrassom transvaginal, doppler, diagnóstico por imagem, Caraguatatuba",
    ogTitle: "Ultrassom em Caraguatatuba | Total Quality",
    ogDescription: "Todos os principais tipos de ultrassom: abdominal, obstétrico, morfológico, transvaginal, mama, tireoide e Doppler vascular.",
  ...
  "teste-ergometrico": {
    title: "Teste Ergométrico em Caraguatatuba | Total Quality",
    description: "Teste ergométrico (teste de esforço) em Caraguatatuba - SP na Total Quality. Avaliação do coração durante exercício na esteira. Agende pelo WhatsApp.",
    keywords: "teste ergométrico, teste de esforço, teste da esteira, avaliação cardíaca, cardiologia, Caraguatatuba",
    ogTitle: "Teste Ergométrico | Total Quality",
    ogDescription: "Avaliação do coração durante o esforço físico com acompanhamento médico.",
    canonical: "https://totalquality.med.br/exames/teste-ergometrico",
    priority: 0.9,
    changefreq: "monthly",
  },
  "exame-admissional": {
    title: "Exame Admissional em Caraguatatuba | Exames Ocupacionais",
    description: "Exame admissional em Caraguatatuba - SP na Total Quality: exames laboratoriais, toxicológico e complementares para PCMSO. Atendimento ágil a empresas.",
    ...
    ogTitle: "Exames Ocupacionais | Total Quality",
    ogDescription: "Exames admissionais, periódicos e demissionais para o PCMSO da sua empresa em Caraguatatuba.",
